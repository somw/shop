                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-body">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th class="text-center">左图定位</th>
                                                <th class="text-center">图片</th>
                                                <th class="text-center">图片链接</th>
                                                <th class="text-center">顶级栏目关联左图</th>
                                                <th class="text-center">操作</th>
                                            </tr>
                                        </thead>

                                        <tbody>
                                            <?php if(is_array($calist) || $calist instanceof \think\Collection || $calist instanceof \think\Paginator): $i = 0; $__LIST__ = $calist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td align="center"><?php echo $link['ca_id']; ?></td>
                                                <td><?php echo $link['ca_position']; ?></td>
                                                <td align="center">
                                                    <?php if($link['ca_img'] != ''): ?>
                                                        <img src="/static/uploads/<?php echo $link['ca_img']; ?>" height="30">
                                                    <?php else: ?>
                                                        暂无图片
                                                    <?php endif; ?>
                                                </td>
                                                <td align="center"><?php echo $link['ca_link']; ?></td>
                                                <td align="center"><?php echo $link['shopcate_name']; ?></td>
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('ca_id'=>$link['ca_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('ca_id'=>$link['ca_id'])); ?>')" class="btn btn-danger btn-sm shiny">
                                ...
                                <div><?php echo $calist->render(); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
