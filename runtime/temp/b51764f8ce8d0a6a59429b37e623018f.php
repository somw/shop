                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <label style="padding-left: 5px;">
                                                        <input type="checkbox" name="recpos[]" value="<?php echo $goodsrec['rec_id']; ?>" class="colored-blue">
