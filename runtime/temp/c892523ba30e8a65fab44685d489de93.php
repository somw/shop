            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                   <li>
                    ...
                    <li>
                        <a href="<?php echo url('shopcate_brand/lst'); ?>">关联品牌管理</a>
                    </li>
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                    	<input type="hidden" name="cb_id" value="<?php echo $cbedit['cb_id']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cb_shopcateid">
                                                    ...
                                                    <option <?php if($scate['shopcate_id'] == $cbedit['cb_shopcateid']): ?> selected="selected" <?php endif; ?> value="<?php echo $scate['shopcate_id']; ?>"><?php echo $scate['shopcate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($cbedit['cb_proimg'] != ''): ?>
                                                <img src="/static/uploads/<?php echo $cbedit['cb_proimg']; ?>">
                                                <?php else: ?>
                                                暂无图片
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" name="cb_prourl" type="text" value="<?php echo $cbedit['cb_prourl']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cb_status" class="colored-blue" value="1" <?php if($cbedit['cb_status'] == 1): ?> checked="checked" <?php endif; ?> type="radio">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="link_status" class="colored-blue" value="0" <?php if($cbedit['cb_status'] == 0): ?> checked="checked" <?php endif; ?> type="radio">
