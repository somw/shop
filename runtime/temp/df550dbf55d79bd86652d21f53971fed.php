<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"B:\aaaweb\shop\public/../application/admin\view\article\lst.html";i:1562460293;s:55:"B:\aaaweb\shop\application\admin\view\common\_meta.html";i:1562460293;s:53:"B:\aaaweb\shop\application\admin\view\common\top.html";i:1562460293;s:54:"B:\aaaweb\shop\application\admin\view\common\list.html";i:1562460293;s:57:"B:\aaaweb\shop\application\admin\view\common\_footer.html";i:1562460293;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<!-- /Page Sidebar -->
        ...
        <div class="page-content">
            ...
            <!-- Page Body -->
            <div class="page-body">
                <button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('article/add'); ?>'">添加文章
                </button>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-body">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th class="text-center">是否顶置</th>
                                                <th class="text-center">状态</th>
                                                <th class="text-center">操作</th>
                                            </tr>
                                        </thead>
                                        <?php if(is_array($arlist) || $arlist instanceof \think\Collection || $arlist instanceof \think\Paginator): $i = 0; $__LIST__ = $arlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="center">
                                                <?php if($article['ar_img'] != ''): ?>
                                                    <img height="30" src="/static/uploads/<?php echo $article['ar_img']; ?>">
                                                 <?php else: ?>
                                                    暂无图片
                                                <?php endif; ?>
                                                </td>
                                                <td align="center"><?php echo $article['ar_author']; ?></td>
                                                <td><?php echo date('Y-d-m',$article['ar_addtime']); ?></td>
                                                <td align="center">
                                ...
                                <div><?php echo $arlist->render(); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
