<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\aaaweb\shop\public/../application/admin\view\attr\lst.html";i:1548611378;s:55:"D:\aaaweb\shop\application\admin\view\common\_meta.html";i:1548611271;s:53:"D:\aaaweb\shop\application\admin\view\common\top.html";i:1547266340;s:54:"D:\aaaweb\shop\application\admin\view\common\list.html";i:1547306096;s:57:"D:\aaaweb\shop\application\admin\view\common\_footer.html";i:1548611169;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<!-- /Page Sidebar -->
        ...
        <div class="page-content">
            ...
            <!-- Page Body -->
            <div class="page-body">
                <button type="button" tooltip="添加商品类型" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('attr/add'); ?>'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php if(is_array($attrlst) || $attrlst instanceof \think\Collection || $attrlst instanceof \think\Paginator): $i = 0; $__LIST__ = $attrlst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                                        <tbody>
                                            <tr>
                                                <td align="center"><?php echo $attr['attr_id']; ?></td>
                                                ...
                                                <td><?php echo $attr['attr_default']; ?></td>
                                                <td><?php echo $attr['type_name']; ?></td>
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('attr_id'=>$attr['attr_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('attr_id'=>$attr['attr_id'])); ?>')" class="btn btn-danger btn-sm shiny">
                                ...
                                <div><?php echo $attrlst->render(); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
