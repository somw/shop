<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"D:\aaaweb\shop\public/../application/admin\view\shopcate_words\add.html";i:1557543096;s:55:"D:\aaaweb\shop\application\admin\view\common\_meta.html";i:1551281420;s:53:"D:\aaaweb\shop\application\admin\view\common\top.html";i:1551281420;s:54:"D:\aaaweb\shop\application\admin\view\common\list.html";i:1557540189;s:57:"D:\aaaweb\shop\application\admin\view\common\_footer.html";i:1551281420;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div class="page-sidebar" id="sidebar">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            <a href="#" class="menu-dropdown">
                <i class="menu-icon fa fa-gear"></i>
                <span class="menu-text">品牌关联管理</span>
                <i class="menu-expand"></i>
            </a>
            <ul class="submenu" style="display: block;">
                <li>
                    <a href="<?php echo url('shopcate_brand/lst'); ?>">
                        <span class="menu-text">品牌关联列表</span>
                        <i class="menu-expand"></i>
                    </a>
                </li>
                <li>
                    <a href="<?php echo url('shopcate_brand/add'); ?>">
                        <span class="menu-text">添加品牌关联词</span>
                        <i class="menu-expand"></i>
                    </a>
                </li>
            </ul>
