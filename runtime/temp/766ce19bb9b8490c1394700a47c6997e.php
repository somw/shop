                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" method="post">
                                        <input type="hidden" name="attr_id" value="<?php echo $attredit['attr_id']; ?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="attr_typeid">
                                                    ...
                                                    <option <?php if($type['type_id'] == $attredit['attr_typeid']): ?> selected="selected" <?php endif; ?> value="<?php echo $type['type_id']; ?>"><?php echo $type['type_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="attr_name"  type="text"  required="" value="<?php echo $attredit['attr_name']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="attr_type"  type="radio" value="1" <?php if($attredit['attr_type'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue">
                                                        <span class="text">单选</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="attr_type"  type="radio" value="2" <?php if($attredit['attr_type'] == 2): ?> checked="checked" <?php endif; ?> class="colored-blue">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  name="attr_default"  type="text" value="<?php echo $attredit['attr_default']; ?>">
                                            </div>
                                        </div>
