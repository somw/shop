                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" method="post">
                                        <input type="hidden" name="type_id" value="<?php echo $typeedit['type_id']; ?>">
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">属性名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="type_name"  type="text"  required="" value="<?php echo $typeedit['type_name']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input value="1" name="type_showtype" <?php if($typeedit['type_showtype'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue"  type="radio">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input value="0" name="type_showtype" <?php if($typeedit['type_showtype'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
