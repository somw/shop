                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cate_pid">
                                                    ...
                                                    <option <?php if($cate['cate_id'] == $cateedit['cate_pid']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['cate_id']; ?>">
                                                        <?php echo str_repeat('-',$cate['lever']*8)?><?php echo $cate['cate_name']; ?>
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="cate_name"  type="text" value="<?php echo $cateedit['cate_name']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cate_type" value="1" <?php if($cateedit['cate_type'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                                        <span class="text">系统分类</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cate_type" value="2" <?php if($cateedit['cate_type'] == 2): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                                        <span class="text">帮助分类</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cate_type" value="3" <?php if($cateedit['cate_type'] == 3): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                                        <span class="text">网店帮助</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cate_type" value="4" <?php if($cateedit['cate_type'] == 4): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                                        <span class="text">网店信息</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cate_type" value="5" <?php if($cateedit['cate_type'] == 5): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="cate_keywords"><?php echo $cateedit['cate_keywords']; ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="cate_description"><?php echo $cateedit['cate_description']; ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="cate_shownav" class="colored-blue" value="1" <?php if($cateedit['cate_shownav'] == 1): ?> checked="checked" <?php endif; ?> type="radio">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="cate_shownav" class="colored-blue" value="0" <?php if($cateedit['cate_shownav'] == 0): ?> checked="checked" <?php endif; ?> type="radio">
