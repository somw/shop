                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                    	<input type="hidden" name="link_id" value="<?php echo $linkedit['link_id']; ?>">
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">链接名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="link_title" type="text" value="<?php echo $linkedit['link_title']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="link_url" type="text" value="<?php echo $linkedit['link_url']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="username" placeholder="" name="link_logo" type="file">
                                                <input type="button" name="link_logo" <?php if($linkedit['link_logo'] != ''): ?> value="删除" <?php endif; ?>>
                                                <?php if($linkedit['link_logo'] != ''): ?>
                                                <img src="/static/uploads/<?php echo $linkedit['link_logo']; ?>" height="30">
                                                <?php else: ?>
                                                暂无图片
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="link_description"><?php echo $linkedit['link_description']; ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="link_type" class="colored-blue" value="1" <?php if($linkedit['link_type'] == 1): ?> checked="checked" <?php endif; ?> type="radio">
                                                        <span class="text">文字</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="link_type" class="colored-blue" value="2" <?php if($linkedit['link_type'] == 2): ?> checked="checked" <?php endif; ?> type="radio">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float: left; padding-right: 10px;">
                                                    <label>
                                                        <input name="link_status" class="colored-blue" value="1" <?php if($linkedit['link_status'] == 1): ?> checked="checked" <?php endif; ?> type="radio">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="link_status" class="colored-blue" value="0" <?php if($linkedit['link_status'] == 0): ?> checked="checked" <?php endif; ?> type="radio">
