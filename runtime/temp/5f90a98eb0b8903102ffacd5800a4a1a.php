...
<!-- /Page Sidebar -->
        ...
        <div class="page-content">
            ...
            <!-- Page Body -->
            <div class="page-body">
                <button type="button" tooltip="添加品牌" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('link/add'); ?>'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center"><?php echo $link['link_id']; ?></td>
                                                <td><?php echo $link['link_title']; ?></td>
                                                <td align="center"><?php echo $link['link_url']; ?></td>
                                                <td align="center">
                                                <?php if($link['link_logo'] != ''): ?>
                                                    <img height="30" src="/static/uploads/<?php echo $link['link_logo']; ?>">
                                                 <?php else: ?>
                                                    暂无图片
                                                <?php endif; ?>
                                                </td>
                                                <td><?php echo cut_str($link['link_description'],50); ?></td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo url('edit',array('link_id'=>$link['link_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('link_id'=>$link['link_id'])); ?>')" class="btn btn-danger btn-sm shiny">
                                ...
                                <div><?php echo $linklist->render(); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
